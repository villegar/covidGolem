...
RUN Rscript -e 'remotes::install_version("imputeTS",upgrade="never", version = "3.2")'
RUN Rscript -e 'remotes::install_version("golem",upgrade="never", version = "0.3.1")'
RUN Rscript -e 'remotes::install_version("DT",upgrade="never", version = "0.20")'
RUN Rscript -e 'remotes::install_version("car",upgrade="never", version = "3.0-11")'
RUN Rscript -e 'remotes::install_github("AnalytixWare/ShinySky")'
RUN Rscript -e 'remotes::install_github("villegar/covidGolem", "group_development")'
...
# CMD R -e "options('shiny.port'=80,shiny.host='0.0.0.0');covidGolem::run_app()"
