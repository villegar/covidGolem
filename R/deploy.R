...
rsconnect::setAccountInfo(
  ...
  token  = error_on_missing_name("SHINY_TOKEN"),
  secret = error_on_missing_name("SHINY_SECRET")
)
...
rsconnect::deployApp(
  # appDir = "R",
  appFiles = "app.R",
  # appFiles = c("R/app_ui.R"), #, you can specify which files to deploy,
               #or keep this NULL to deploy everything),
  appName = error_on_missing_name("SHINY_MAINNAME"),
